...
//    if(isset(\App\Config\Routes::routingTable()[$url])) {
//        if(isset(\App\Config\Routes::routingTable()[$url][3])) {
//            $title = \App\Config\Routes::routingTable()[$url][3];
...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <?php $menu = \App\Model\Aquarium::aquariumMenu();

        foreach ($menu['aquariumFirst'] as $menuItem => $page): ?>

        <a class="navbar-brand" href="/<?=$page?>"><?=$menuItem?></a>
        <?php endforeach; ?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php foreach ($menu['aquariumMenu'] as $menuItem => $page): ?>

                    <li class="nav-item">
                        <a class="nav-link" href="/<?=$page?>"><?=$menuItem?></a>
                    </li>
