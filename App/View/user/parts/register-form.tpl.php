...
<!--</div>-->
<div class="form-group">
<input type="password" class="form-control" name="SignupForm[password]" pattern=^[^\s]{6,32}$ placeholder="Password" required autocomplete="new-password" value="">
</div>
<div class="form-group">
<input type="password" class="form-control" name="SignupForm[password-confirm]" pattern=^[^\s]{6,32}$ placeholder="Confirm the password" required autocomplete="new-password" value="">
</div>
<div class="form-group">
